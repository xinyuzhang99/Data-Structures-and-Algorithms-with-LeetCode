...
|  Category  |  Difficulty   |                             Tags                             |
| :--------: | :-----------: | :----------------------------------------------------------: |
| algorithms | Easy (57.86%) | [`math`](https://leetcode.com/tag/math) | [`string`](https://leetcode.com/tag/string) |
...
- **Thoughts**
  ...
  这道题主要是要找到罗马计数的规律：字符串从左到右是从大到小依次相加，如果有小数字母在大数前面，则小数字母为负，在结果中减去

- **Solution**

  ```python
  # largest to smallest: add them up
  # smaller before larger: substract smaller value
